      ...
      <Column xs={12} sm={7} align="flex-start">
        ...
        <p>
          <Text type="normal">
            ...
            them. Sites like Instagram, YouTube, TikTok, and Twitter have taken over and are here to stay. This shift in
            the climate of the internet has burried one of the best kept internet marketing secrets —{' '}
            <b>The Newsletter</b>.
          </Text>
        </p>
        ...
        <p>
          <Text type="normal">
            ...
            influencers are ignoring email as a marketing channel. <em>Why?</em> Because mailing lists have always been
            astonishingly hard to build.
          </Text>
        </p>
        <p>
          <Text type="normal">
            <b>We think that newsletters deserve a do-over.</b> A revamp. Updated to the way we interact with our fans
            today. At Mailr, we’ve done just that. A completely new way to think about your audience. A fresh start that
        ...
        <blockquote>
          <Text type="normal">
            ...
            networks (13%). Email was the only service chosen by a substantial proportion of respondents in all nations,
            lowest in Italy at 16%. It was the first choice in Japan, and the second most popular choice in every other
            nation - possibly because it is a long-established communications service.
          </Text>
        </blockquote>
        <p>
          <Text type="normal">
        ...
        <p>
          <Text type="normal">
            ...
            generous free tier for people just getting started with their audience. If you haven't yet, go check out all
            the free features you get on our{' '}
            <Link href="/pricing">
              <a>Pricing</a>
            </Link>{' '}
            page.
