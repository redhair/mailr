const theme = {
  ...
  lightSecondaryColor: '#64d2aa',
  successColor: '#3ead87',
  dangerColor: 'rgb(246, 119, 119)',
  lightDangerColor: '#ec6780',
  ...
  darkGrey: '#273a55',
  blackBlue: '#191f2b',
  blackBlueGrey: '#7e96b8',
  darkBlackBlue: '#1c2d4a',

  fontSize: '1.1rem',
  textColor: '#ffffff',
  textColorGrey: '#7e96b8',
  borderRadius: '50px',
  backgroundColor: 'transparent', //'#191f2b',
  backgroundBodyColor: 'linear-gradient(180deg, #0e131d, #060a10 30.65%)',
